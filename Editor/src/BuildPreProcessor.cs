...
namespace RGN.MyEditor
{
    ...
    {
        private const string PackagesFolderPath = "Packages/io.getready.rgn.signin.email";
        private const string DestinationLinkPath = "Assets/ReadyGamesNetwork/Linker/RGNSignInEmail";
        ...
        {
            Debug.Log("[RGNSignInEmail] Build PreProcessor");
